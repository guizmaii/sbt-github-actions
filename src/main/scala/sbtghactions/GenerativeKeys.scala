...
trait GenerativeKeys {
  ...
  lazy val githubWorkflowPRTargetBranches = settingKey[Option[Seq[String]]]("A list of branch patterns on which to trigger PR builds, or None for all PRs (default: None)")
